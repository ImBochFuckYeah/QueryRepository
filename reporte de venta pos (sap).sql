...
--- VALORES VARIABLES
SET @FechaIni = '2024-09-01'
SET @FechaFin = '2024-09-20'
SET @Empresa  = '00005'
-- SET @Tienda   = '00002'
 
--- CREACIÓN TABLE TEMPORAL
CREATE TABLE Temp_ReportIva (
	idFact		NVARCHAR(15),
	Empresa		NVARCHAR(05),
	CodTda		NVARCHAR(05),
	NomTda		NVARCHAR(150),
...
--- DATOS DE LA FACTURA
INSERT INTO Temp_ReportIva (idFact, Empresa, CodTda, NomTda, NitClie, NomClie, ConFact, NumCont, SerFact, NumFact, UidFact, FecFact, CerFact, TotFact, EstFact, idUnico, TotDet)
SELECT 
T1.idfactura, 
T1.empresa,
T1.tienda,
...
-- INSERT INTO Temp_ReportIva (Empresa, Tienda, FecFact, CerFact, TotValI)
